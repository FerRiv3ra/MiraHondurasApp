        ...
        <View style={styles.viewBody}>
            {places ? (
                ...
                <View style={styles.loaderPlace}>
                    ...
                    <Text style={{textAlign: 'center', fontSize: verticalScale(13)}}>Cargando favoritos</Text>
                </View>
            )}
...
function NotFoundPlaces(){
    return(
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            ...
            />
            <Text 
                style={{fontSize: verticalScale(20), fontWeight: 'bold'}}>
...
function UserNoLogged({navigation}){
    return(
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            ...
            />
            <Text 
                style={{fontSize: verticalScale(18), fontWeight: 'bold', textAlign: 'center'}}>
...
function Place({place, toastRef, setIsLoading, setReloadData, navigation}){
            ...
            .then((response) => {
                response.forEach((doc) => {
                    ...
                    db.collection('favorites')
                        ...
                        .catch(() => {
                            setIsLoading(false);
                            toastRef.current.show('Error al eliminar favorito, intenta más tarde', 2000)
                        })
                })
            })
    }
    ...
    return(
        <View style={styles.place}>
            <TouchableOpacity onPress={() => navigation.navigate('places', {screen: 'place', params: {id, name}})}>
                <Image 
                    resizeMode='cover'
                    style={styles.img}
