...
import { moderateScale, verticalScale, scale } from '../../../config/react-native-size';
        ...
        <View>
            {userLogged ? (
                <Button 
                    ...
                    onPress={() => navigation.navigate('addreviewplace', {
                        idPlace
                    })}
                />
            ) : (
                <View>
                    <Text 
                        style={{textAlign: "center", color: '#00A680', padding: moderateScale(20)}}
                        onPress={() => navigation.navigate('account')}
                    >
                        Es necesario estar registrado para escribir un comentario,
                        <Text style={{fontWeight: 'bold'}}> pulsa AQUÍ para inciar sesión</Text>
                    </Text>
                </View>
            )}
            {
        ...
        <View style={styles.viewReview}>
            ...
            <View style={styles.viewInfo}>
                ...
                <Text style={styles.reviewData}>
                    {createdReview.getDate()}/{createdReview.getMonth() + 1}/{createdReview.getFullYear()} </Text>
            </View>
        </View>
    )
}
